module liquidity_layer::fee_balance {
    use std::option;
    ...
    public fun distribute_fee_to_intermediary<T, FT>(
        ...
        let fee_opt = df::remove_if_exists<FeeBalanceDfKey, FeeBalance<FT>>(
            metadata, FeeBalanceDfKey {},
        );
    ...
    public fun paid_in_fees<T, FT>(
        ...
        let fee_balance = df::borrow<FeeBalanceDfKey, FeeBalance<FT>>(
            tr::metadata(self), FeeBalanceDfKey {},
        );
    ...
    public fun paid_in_fees_mut<T, FT>(
        ...
        let fee_balance = df::borrow_mut<FeeBalanceDfKey, FeeBalance<FT>>(
            tr::metadata_mut(self), FeeBalanceDfKey {},
        );
